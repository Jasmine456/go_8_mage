...
//	创建一个Rand
	...
	fmt.Println()
	source.Seed(2) //必须重置下Seed ，不然随机种子是相同的
	...
	fmt.Println(rand.Intn(100))//100 以内的随机证书，[0,100]
