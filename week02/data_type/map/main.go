...
//map中的key可以是任意能够用 == 操作符比较的类型
//不能是函数、map、切片，以及包含上述3中类型成员变量的struct
func key_type() {
...
func main() {
	...
	m = map[string]int{"语文": 66, "数学": 39, "物理": 57, "历史": 49} //初始化时直接赋值
	m["英语"] = 59                                               //在map里添加key-value对
