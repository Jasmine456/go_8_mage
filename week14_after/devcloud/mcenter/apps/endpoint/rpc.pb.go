...
var file_apps_endpoint_pb_rpc_proto_rawDesc = []byte{
	...
	0x38, 0x2e, 0x64, 0x65, 0x76, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x6d, 0x63, 0x65, 0x6e, 0x74,
	0x65, 0x72, 0x2e, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x2e, 0x45, 0x6e, 0x64, 0x70,
	0x6f, 0x69, 0x6e, 0x74, 0x53, 0x65, 0x74, 0x42, 0x4d, 0x5a, 0x4b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_apps_endpoint_pb_rpc_proto_goTypes = []interface{}{
	(*RegistryRequest)(nil),         // 0: go8.devcloud.mcenter.tools.RegistryRequest
	(*RegistryResponse)(nil),        // 1: go8.devcloud.mcenter.tools.RegistryResponse
	(*DescribeEndpointRequest)(nil), // 2: go8.devcloud.mcenter.tools.DescribeEndpointRequest
	(*QueryEndpointRequest)(nil),    // 3: go8.devcloud.mcenter.tools.QueryEndpointRequest
	nil,                             // 4: go8.devcloud.mcenter.tools.QueryEndpointRequest.LabelsEntry
	(*Entry)(nil),                   // 5: go8.devcloud.mcenter.tools.Entry
	(*request.PageRequest)(nil),     // 6: infraboard.mcube.page.PageRequest
	(*Endpoint)(nil),                // 7: go8.devcloud.mcenter.tools.Endpoint
	(*EndpointSet)(nil),             // 8: go8.devcloud.mcenter.tools.EndpointSet
}
var file_apps_endpoint_pb_rpc_proto_depIdxs = []int32{
	5, // 0: go8.devcloud.mcenter.tools.RegistryRequest.entries:type_name -> go8.devcloud.mcenter.tools.Entry
	6, // 1: go8.devcloud.mcenter.tools.QueryEndpointRequest.page:type_name -> infraboard.mcube.page.PageRequest
	4, // 2: go8.devcloud.mcenter.tools.QueryEndpointRequest.labels:type_name -> go8.devcloud.mcenter.tools.QueryEndpointRequest.LabelsEntry
	0, // 3: go8.devcloud.mcenter.tools.RPC.RegistryEndpoint:input_type -> go8.devcloud.mcenter.tools.RegistryRequest
	2, // 4: go8.devcloud.mcenter.tools.RPC.DescribeEndpoint:input_type -> go8.devcloud.mcenter.tools.DescribeEndpointRequest
	3, // 5: go8.devcloud.mcenter.tools.RPC.QueryEndpoints:input_type -> go8.devcloud.mcenter.tools.QueryEndpointRequest
	1, // 6: go8.devcloud.mcenter.tools.RPC.RegistryEndpoint:output_type -> go8.devcloud.mcenter.tools.RegistryResponse
	7, // 7: go8.devcloud.mcenter.tools.RPC.DescribeEndpoint:output_type -> go8.devcloud.mcenter.tools.Endpoint
	8, // 8: go8.devcloud.mcenter.tools.RPC.QueryEndpoints:output_type -> go8.devcloud.mcenter.tools.EndpointSet
