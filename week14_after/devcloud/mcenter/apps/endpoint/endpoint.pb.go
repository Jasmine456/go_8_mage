...
// 	protoc        v3.21.6
// source: apps/tools/pb/tools.proto
...
var file_apps_endpoint_pb_endpoint_proto_rawDesc = []byte{
	...
	0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x42, 0x4d, 0x5a,
	0x4b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4a, 0x61, 0x73, 0x6d,
...
var file_apps_endpoint_pb_endpoint_proto_goTypes = []interface{}{
	(*Endpoint)(nil),    // 0: go8.devcloud.mcenter.tools.Endpoint
	(*Entry)(nil),       // 1: go8.devcloud.mcenter.tools.Entry
	(*EndpointSet)(nil), // 2: go8.devcloud.mcenter.tools.EndpointSet
	nil,                 // 3: go8.devcloud.mcenter.tools.Entry.LabelsEntry
	nil,                 // 4: go8.devcloud.mcenter.tools.Entry.ExtensionEntry
}
var file_apps_endpoint_pb_endpoint_proto_depIdxs = []int32{
	1, // 0: go8.devcloud.mcenter.tools.Endpoint.entry:type_name -> go8.devcloud.mcenter.tools.Entry
	3, // 1: go8.devcloud.mcenter.tools.Entry.labels:type_name -> go8.devcloud.mcenter.tools.Entry.LabelsEntry
	4, // 2: go8.devcloud.mcenter.tools.Entry.extension:type_name -> go8.devcloud.mcenter.tools.Entry.ExtensionEntry
	0, // 3: go8.devcloud.mcenter.tools.EndpointSet.items:type_name -> go8.devcloud.mcenter.tools.Endpoint
