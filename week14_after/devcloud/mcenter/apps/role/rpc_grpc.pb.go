...
func (c *rPCClient) QueryRole(ctx context.Context, in *QueryRoleRequest, opts ...grpc.CallOption) (*RoleSet, error) {
	out := new(RoleSet)
	err := c.cc.Invoke(ctx, "/go8.devcloud.mcenter.role.RPC/QueryRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) DescribeRole(ctx context.Context, in *DescribeRoleRequest, opts ...grpc.CallOption) (*Role, error) {
	out := new(Role)
	err := c.cc.Invoke(ctx, "/go8.devcloud.mcenter.role.RPC/DescribeRole", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) QueryPermission(ctx context.Context, in *QueryPermissionRequest, opts ...grpc.CallOption) (*PermissionSet, error) {
	...
	err := c.cc.Invoke(ctx, "/go8.devcloud.mcenter.role.RPC/QueryPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rPCClient) DescribePermission(ctx context.Context, in *DescribePermissionRequest, opts ...grpc.CallOption) (*Permission, error) {
	out := new(Permission)
	err := c.cc.Invoke(ctx, "/go8.devcloud.mcenter.role.RPC/DescribePermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RPC_QueryRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go8.devcloud.mcenter.role.RPC/QueryRole",
	}
...
func _RPC_DescribeRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go8.devcloud.mcenter.role.RPC/DescribeRole",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RPC_QueryPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go8.devcloud.mcenter.role.RPC/QueryPermission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RPC_DescribePermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go8.devcloud.mcenter.role.RPC/DescribePermission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
