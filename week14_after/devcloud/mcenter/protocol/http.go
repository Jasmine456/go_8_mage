...
func NewHTTPService() *HTTPService {
	...
	// auth.Handle("/apidocs/", auth.StripPrefix("/apidocs/", auth.FileServer(auth.Dir("/Users/emicklei/Projects/swagger-ui/dist"))))
	...
	//添加一个认证中间件
	r.Filter(auth.NewAuther().GoRestfulAutherFun)
...
func (s *HTTPService) Start() error {
	...
	s.l.Infof("Get the API using auth://%s%s", s.c.App.HTTP.Addr(), config.APIPath)
